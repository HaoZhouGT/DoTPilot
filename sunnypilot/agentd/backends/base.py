...
class BaseLLMBackend(ABC):
  """Abstract interface for LLM backends (cloud API or on-device model)."""
  ...
  def invoke(self, context: dict, tools: list[dict], system_prompt: str) -> dict:
    ...
    Args:
      ...
      tools: List of tool schemas in Anthropic tool_use format.
      system_prompt: System prompt including skill fragments.

    Returns:
      Raw LLM response dict containing either text or tool_use blocks.
    """
    ...
